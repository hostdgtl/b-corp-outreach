...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Fussy/assets/';
  ...
  var defaults = {
    brandName: 'Fussy',
    brandLogo: CDN_BASE + 'Fussy-Logo.svg',
    ...
    environment: 24.1,
    customers: 3.8,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/fussy-ltd/'
  };
