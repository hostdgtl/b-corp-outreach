...
{
  window.BCORP_CONFIG = {
    brandName: 'Micro Scooters',
    brandLogo: 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Micro-Scooters/assets/Micro-Scooters-Logo.svg',
    overallScore: 100.5,
    ...
    environment: 25.1,
    customers: 12.4,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/micro-scooters-ltd/'
  };
