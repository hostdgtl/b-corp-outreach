{
  window.BCORP_CONFIG = {
    brandName: 'Kit & Kin',
    brandLogo: 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Kit-Kin/assets/Kit-Kin-Logo.png',
    overallScore: 87.8,
    certificationDate: 'August 2022',
    qualifyingScore: 80,
    medianScore: 50.9,
    governance: 16.7,
    workers: 26.5,
    ...
    environment: 21.5,
    customers: 4.8,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/kit-and-kin-ltd/'
  };
