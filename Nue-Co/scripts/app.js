...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Nue-Co/assets/';
  ...
  var defaults = {
    brandName: 'The Nue Co.',
    brandLogo: CDN_BASE + 'Nue-Co-Logo.svg',
    ...
    environment: 24.3,
    customers: 2.9,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/the-nue-co/'
  };
