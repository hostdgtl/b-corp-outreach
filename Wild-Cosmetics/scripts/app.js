...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Wild-Cosmetics/assets/';
  ...
  var defaults = {
    brandName: 'Wild Cosmetics',
    brandLogo: CDN_BASE + 'Wild-Cosmetics-Logo.png',
    ...
    environment: 42.6,
    customers: 3.1,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/wild-cosmetics/'
  };
