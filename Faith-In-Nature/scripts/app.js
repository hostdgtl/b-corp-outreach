...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Faith-In-Nature/assets/';
  ...
  var defaults = {
    ...
    brandLogo: CDN_BASE + 'Faith-In-Nature-Logo.svg',
    ...
    environment: 21.1,
    customers: 3.1,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/faith-in-nature/'
  };
