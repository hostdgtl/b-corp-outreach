...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Absolute-Collagen/assets/';
  ...
  var defaults = {
    brandName: 'Absolute Collagen',
    brandLogo: CDN_BASE + 'Absolute-Collagen-Logo.svg',
    ...
    environment: 12.6,
    customers: 4.6,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/absolute-collagen-group/'
  };
