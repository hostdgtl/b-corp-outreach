```javascript
{
  window.BCORP_CONFIG = {
    brandName: 'Liforme',
    brandLogo: 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Liforme/assets/Liforme-Logo.png',
    overallScore: 115.1,
    ...
    environment: 29.2,
    customers: 11.5,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/liforme/'
  };
