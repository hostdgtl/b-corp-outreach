```js
{
  window.BCORP_CONFIG = {
    brandName: 'Neat.',
    brandLogo: 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Neat/assets/Neat-Logo.webp',
    overallScore: 97.2,
    ...
    environment: 32.4,
    customers: 3.4,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/neat-home-ltd/'
  };
