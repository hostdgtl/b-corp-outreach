...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Lintbells/assets/';
  ...
  var defaults = {
    brandName: 'YuMOVE',
    brandLogo: CDN_BASE + 'Lintbells-Logo.png',
    ...
    environment: 17.4,
    customers: 3.1,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/lintbells-health-limited/'
  };
