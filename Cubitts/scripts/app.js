...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Cubitts/assets/';
  ...
  var defaults = {
    brandName: 'Cubitts',
    brandLogo: CDN_BASE + 'Cubitts-Logo.png',
    ...
    environment: 21.4,
    customers: 2.7,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/cubitts/'
  };
