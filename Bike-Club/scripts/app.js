...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Bike-Club/assets/';
  ...
  var defaults = {
    brandName: 'Bike Club',
    brandLogo: CDN_BASE + 'Bike-Club-Logo.png',
    ...
    environment: 26.7,
    customers: 10.5,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/bike-club/'
  };
