```javascript
{
  window.BCORP_CONFIG = {
    brandName: 'Beco Pets',
    brandLogo: 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Beco-Pets/assets/Beco-Pets-Logo.png',
    overallScore: 101.6,
    certificationDate: 'July 2022',
    qualifyingScore: 80,
    medianScore: 50.9,
    governance: 17.6,
    workers: 21.0,
    ...
    environment: 40.6,
    customers: 3.5,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/wannabeco-ltd-ta-beco-pets/'
  };
  ...
  // Scroll fix — Klaviyo class + inline style both block scrolling
  document.body.classList.remove('klaviyo-prevent-body-scrolling');
  document.body.style.overflow = '';
  const scrollFixStyle = document.createElement('style');
  scrollFixStyle.innerHTML = `body { overflow: auto !important; overflow-x: hidden !important; }`;
