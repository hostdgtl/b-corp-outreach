...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Gibsons-Games/assets/';
  ...
  var defaults = {
    brandName: 'Gibsons Games',
    brandLogo: CDN_BASE + 'Gibsons-Games-Logo.png',
    bcorpLogo: CDN_BASE + 'b-corp-logo.png',
    overallScore: 113.2,
    certificationDate: 'November 2023',
    qualifyingScore: 80,
    medianScore: 50.9,
    governance: 16.6,
    workers: 24.6,
    ...
    environment: 45.9,
    customers: 4.6,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/gibsons-games-ltd/'
  };
