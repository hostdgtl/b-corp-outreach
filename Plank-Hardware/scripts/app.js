...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Plank-Hardware/assets/';
  ...
  var defaults = {
    brandName: 'Plank Hardware',
    brandLogo: CDN_BASE + 'Plank-Hardware-Logo.png',
    ...
    environment: 19.3,
    customers: 4.3,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/andcrafted-ltd-ta-plank-hardware/'
  };
