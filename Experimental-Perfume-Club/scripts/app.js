...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/Experimental-Perfume-Club/assets/';
  ...
  var defaults = {
    ...
    brandLogo: CDN_BASE + 'Experimental-Perfume-Club-Logo.webp',
