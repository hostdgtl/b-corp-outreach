...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/WUKA/assets/';
  ...
  var defaults = {
    brandName: 'WUKA',
    brandLogo: CDN_BASE + 'WUKA-Logo.svg',
    bcorpLogo: CDN_BASE + 'b-corp-logo.png',
    overallScore: 111.4,
    certificationDate: 'April 2023',
    qualifyingScore: 80,
    medianScore: 50.9,
    governance: 15.4,
    workers: 23.1,
    ...
    environment: 44.1,
    customers: 3.1,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/wuka/'
  };
