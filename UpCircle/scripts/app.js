...
(function () {
  ...
  var CDN_BASE = 'https://cdn.jsdelivr.net/gh/hostdgtl/b-corp-outreach@main/UpCircle/assets/';
  ...
  var defaults = {
    brandName: 'UpCircle Beauty',
    brandLogo: CDN_BASE + 'UpCircle-Logo.png',
    ...
    environment: 34.7,
    customers: 4.0,
    profileUrl: 'https://www.bcorporation.net/en-us/find-a-b-corp/company/optiat-ltd-ta-up-circle-beauty/'
  };
